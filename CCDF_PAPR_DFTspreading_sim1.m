...
function [CCDF,PAPRs]=CCDF_PAPR_DFTspreading_sim1(fdma_type,Ndb,b,N,dBcs,Nblk,psf,Nos)
...
M=2^b;
Es=1; 
A=sqrt(3/2/(M-1)*Es); % Alphbet size and Normalization factor for QAM
% mod_object = qammod();
